          ...
          <div className="flex items-start gap-4 mb-6 pb-4 border-b border-gray-200">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-base text-blue-600 font-medium">• </span>
                {isEditing ? (
                  <input
                    type="text"
                    name="company"
                    ...
                    onChange={handleInputChange}
                    className="text-base text-blue-600 font-medium border border-gray-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                ) : (
          ...
          <div className="mb-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-3 border border-gray-200">
              <div className={`grid gap-4 ${
                ...
                <div className={`${isEditing ? 'md:col-span-2 lg:col-span-3' : 'md:col-span-2 lg:col-span-4'}`}>
          ...
          <div className="border-t border-gray-200 pt-4">
            ...
            <div className="space-y-3">
              {licenses.map((license, index) => {
                ...
                return (
                <div key={license.id} className="bg-white rounded-lg shadow-md p-3 border border-gray-200">
            ...
            <div className="mt-6">
              ...
              <div className="space-y-3">
                {certifications.map((certification, index) => {
                  ...
                  return (
                  <div key={certification.id} className="bg-white rounded-lg shadow-md p-3 border border-gray-200">
                    <div className="flex items-center justify-end mb-2">
                      {isEditing && (
                        <button
                    ...
                    <div className={`grid gap-3 ${
                      ...
                      <div>
                        ...
                        {isEditing ? (
                          ...
                          <p className="text-gray-900 font-medium">{certification.name}</p>
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        {isEditing ? (
                          ...
                          <p className="text-gray-900 font-medium">{certification.number}</p>
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        {isEditing ? (
                          ...
                          <p className="text-gray-900 font-medium">{certification.class}</p>
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        {isEditing ? (
                          ...
                          <p className="text-gray-900 font-medium">{certification.issuingAuthority}</p>
                        )}
                      </div>
                    </div>
                  </div>
